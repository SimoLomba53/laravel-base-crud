<h1 class="text-center">MODIFICA CANZONE</h1>
...
<div class="col-6 offset-3">
 ...
 <div>
    ...
    <input type="number" class="form-control  @error('length') is-invalid @enderror" id="length" name="length" value="{{ old('length') ?? $song->length}}">
    @error('length')
    <div class="invalid-feedback">
      {{$message}}
    </div>
